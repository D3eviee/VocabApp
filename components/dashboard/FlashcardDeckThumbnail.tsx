...
export const FlashcardDeckThumbnail = ({deck}:{deck: DeckThumbtail}) => {
    const { id, title } = deck
    return (
        <div className="w-full bg-white rounded-4xl border border-gray-200 p-6 flex flex-col hover:border-gray-300 transition-colors">
            ...
            <div className="w-full flex flex-col mt-6">
                <Link
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-gray-950 hover:bg-black text-white py-3 rounded-2xl text-13 font-semibold transition-all active:scale-95 mb-2"
                >
