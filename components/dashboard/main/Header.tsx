...
export default function Header({user}:HeaderProps) {
    ...
    return (
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-12 animate-in fade-in slide-in-from-top-4 duration-500">
            <div>
                <h1 className="text-2xl md:text-3xl font-semibold tracking-tight">Welcome back, {user && user?.firstName}</h1>
                <p className="text-sm md:text-base text-gray-500 md:mt-1">Let's see how u progressing!</p>
            </div>
            
            <div className="hidden md:flex items-center gap-3 md:mt-6 mt-0">
                <button 
